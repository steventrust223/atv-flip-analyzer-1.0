...
function onOpen() {
  ...
  ui.createMenu('🦅 CarHawk')
    ...
    .addSeparator()
    .addSubMenu(ui.createMenu('➕ Add Deals')
      .addItem('Quick Import', 'showDealEntryForm')
      .addItem('Paste Listing (Legacy)', 'importListing'))
    .addSubMenu(ui.createMenu('📈 Analysis')
      .addItem('View Verdicts', 'showVerdictsPanel')
      .addItem('Normalize Data', 'normalizeAllData')
      .addItem('Update Verdicts', 'updateVerdicts')
      .addItem('Refresh Analysis', 'refreshAnalysis'))
    .addSeparator()
    .addItem('⚙️ Settings', 'showSettingsPanel')
